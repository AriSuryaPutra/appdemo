  ...
  return (
    <div
      className={classnames(`wrapper vertical-layout ${navbarWrapperClasses[navbarType] || 'navbar-floating'} ${footerClasses[footerType] || 'footer-static'}`, {
        // Modern Menu
        'vertical-menu-modern': windowWidth >= 3000,
        'menu-collapsed': menuCollapsed && windowWidth >= 3000,
        'menu-expanded': !menuCollapsed && windowWidth > 3000,

        // Overlay Menu
        'vertical-overlay-menu': windowWidth < 3000,
        'menu-hide': !menuVisibility && windowWidth < 3000,
        'menu-open': menuVisibility && windowWidth < 3000
      })}
    ...
    >
      ...
      >
        <div className="navbar-container d-flex content">{navbar ? navbar : <NavbarComponent setMenuVisibility={setMenuVisibility} skin={skin} setSkin={setSkin} />}</div>
      </Navbar>
      {children}
